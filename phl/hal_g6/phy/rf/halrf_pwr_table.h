...
enum halrf_pw_lmt_regulation_type_6g {
	...
	PW_LMT_REGU_6G_CN_LPI = 35,
	PW_LMT_REGU_6G_CN_STD = 36,
	PW_LMT_REGU_6G_CN_VLP = 37,
	...
	/* place predefined ones above */
	PW_LMT_REGU_6G_PREDEF_NUM = 44,
	PW_LMT_MAX_6G_REGULATION_NUM = 45
};
