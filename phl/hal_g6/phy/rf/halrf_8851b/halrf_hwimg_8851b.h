 ...
 *
 *****************************************************************************/
#ifndef _HALRF_HW_IMG_8851B_H_
#define _HALRF_HW_IMG_8851B_H_
#ifdef RF_8851B_SUPPORT

#define DONT_CARE_8851B	0xff

#define IF_8851B	0x8
#define ELSE_IF_8851B	0x9
#define ELSE_8851B	0xa
#define END_8851B	0xb
#define CHK_8851B	0x4
...
void halrf_config_8851b_radio_a_reg(struct rf_info *rf, enum phl_phy_idx phy);
void halrf_config_8851b_radio_b_reg(struct rf_info *rf, enum phl_phy_idx phy);
void halrf_config_8851b_store_power_by_rate(struct rf_info *rf, enum phl_phy_idx phy);
void halrf_config_8851b_store_power_limit(struct rf_info *rf, enum phl_phy_idx phy);
void halrf_config_8851b_store_power_limit_ru(struct rf_info *rf, enum phl_phy_idx phy);
void halrf_config_8851b_store_pwr_track(struct rf_info *rf, enum phl_phy_idx phy);
void halrf_config_8851b_store_xtal_track(struct rf_info *rf, enum phl_phy_idx phy);

u32 halrf_get_8851b_nctl_reg_ver(void);
u32 halrf_get_8851b_radio_reg_ver(void);

void halrf_config_8851b_radio_to_fw(struct rf_info *rf);

#endif
#endif /*  _HALRF_HW_IMG_8851b_H_ */
