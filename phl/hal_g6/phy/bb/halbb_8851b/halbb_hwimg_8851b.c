...
#include "halbb_hwimg_raw_data_8851b.h"
#include "halbb_hwimg_raw_data_8851b_gain.h"

#ifdef BB_8851B_SUPPORT

#if 0
bool halbb_sel_headline_8851b(struct bb_info *bb, u32 *array, u32 array_len,
...
void halbb_flag_2_default_8851b(bool *is_matched, bool *find_target)
{
	*is_matched = true;
	*find_target = false;
}

bool halbb_cfg_bbcr_ax_8851b(struct bb_info *bb, bool is_form_folder,
			  ...
			  enum phl_phy_idx phy_idx)
{
	...
	if (is_form_folder) {
		...
		array_len = sizeof(array_mp_8851b_phy_reg) / sizeof(u32);
		array = (u32 *)array_mp_8851b_phy_reg;
	}
	...
	halbb_flag_2_default_8851b(&is_matched, &find_target);
	...
	while ((i + 1) < array_len) {
		...
		default:
			if (is_matched)
				halbb_cfg_bb_phy_8851b(bb, v1, v2, phy_idx);
			break;
		}
	}
...
bool halbb_cfg_bb_gain_ax_8851b(struct bb_info *bb, bool is_form_folder,
				u32 folder_len, u32 *folder_array)
{
	bool is_matched, find_target;
	u32 cfg_target = 0, cfg_para = 0;
	...
	if (is_form_folder) {
		...
		array_len = sizeof(array_mp_8851b_phy_reg_gain) / sizeof(u32);
		array = (u32 *)array_mp_8851b_phy_reg_gain;
	}
	...
	while ((i + 1) < array_len) {
		...
		default:
			if (is_matched)
				halbb_cfg_bb_gain_8851b(bb, v1, v2);
			break;
		}
	}
...
u32
halbb_get_8851b_phy_reg_ver(void)
{
		return (u32)BB_REG_RELEASE_VERSION_8851B;
}
