...
#ifndef _TABLEUPD_H2C_8851B_H_
#define _TABLEUPD_H2C_8851B_H_

#include "../../type.h"
#include "../fwcmd.h"
#if MAC_AX_8851B_SUPPORT
/*--------------------Define MACRO--------------------------------------*/
#define CCTL_NTX_PATH_EN_8851B		1
...
/**
 * @brief mac_init_cctl_info_8851b
 *
 * @param *adapter
 * @param *macid
 ...
 * @retval u32
 */
u32 mac_init_cctl_info_8851b(struct mac_ax_adapter *adapter, u8 macid);
/**
 * @}
 * @}
 */
